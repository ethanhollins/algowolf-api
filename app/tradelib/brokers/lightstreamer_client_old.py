...
class LightstreamerClient(object):
    ...
    def __init__(self, broker, lightstreamer_username, lightstreamer_password, lightstreamer_url, adapter_set=''):
        # Brokerlib Broker Instance
        self.broker = broker
    ...
    def _handle_stream(self, stream_line):
        if stream_line == OK_CMD:
            ...
            self._stream_connection_thread = DynamicThread(self.broker.ctrl, self._receive)
    ...
    def _join(self):
        ...
        if self._stream_connection_thread:
            ...
            self._stream_connection_thread.wait()
            self._stream_connection_thread = None
    ...
    def _receive(self):
        ...
        while receive:
            ...
            try:
                ...
                log.error("[LS_STREAM] Communication error")
                # print(traceback.format_exc())
                message = None

                self.broker._reconnect()
